...
# ACDS 25.1 1129 win32 2026.07.08.18:01:42
# ----------------------------------------
...
# ----------------------------------------
# If prop_clk_div is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "prop_clk_div"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/altera_lite/25.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prop_clk_div.vo"
}
